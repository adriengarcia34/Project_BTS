...
// Application_SingleDoc.cpp : Définit les comportements de classe pour l'application.
//
...
BEGIN_MESSAGE_MAP(CApplication_SingleDocApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CApplication_SingleDocApp::OnAppAbout)
...
// construction CApplication_SingleDocApp

CApplication_SingleDocApp::CApplication_SingleDocApp()
{
	...
	SetAppID(_T("Application_SingleDoc.AppID.NoVersion"));

	// TODO: ajoutez ici du code de construction,
	// Placez toutes les initialisations significatives dans InitInstance
}

// Seul et unique objet CApplication_SingleDocApp

CApplication_SingleDocApp theApp;


// initialisation de CApplication_SingleDocApp

BOOL CApplication_SingleDocApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CApplication_SingleDocDoc),
		RUNTIME_CLASS(CMainFrame),       // fenêtre frame SDI principale
		RUNTIME_CLASS(CApplication_SingleDocView));
	if (!pDocTemplate)
		return FALSE;
...
// gestionnaires de messages pour CApplication_SingleDocApp
...
void CApplication_SingleDocApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// CApplication_SingleDocApp, méthodes de chargement/d'enregistrement de la personnalisation

void CApplication_SingleDocApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CApplication_SingleDocApp::LoadCustomState()
{
}

void CApplication_SingleDocApp::SaveCustomState()
{
}
